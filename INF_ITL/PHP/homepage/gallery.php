            ...
            <main class="col-md-8">
                <div class="row">
                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                        <img src="assets/gallery/1.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="assets/gallery/2.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>

                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <img src="assets/gallery/3.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="assets/gallery/4.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>

                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <img src="assets/gallery/5.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="assets/gallery/6.png" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>
                </div>
            </main>
        </div>
