...
select kur.kur_bezeichnung, pf.per_vname, pf.per_nname
from kurs.kurs kur
cross join kurs.person_firma pf
left join kurs.buchung bu on bu.kute_id = kur.kur_id and bu.per_id = pf.per_id
where bu.buc_id is null 
order by kur.kur_bezeichnung, pf.per_nname, pf.per_vname;
